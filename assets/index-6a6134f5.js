import{s as i,t as o,j as s,c as x,u as d,g as w,q as C,v as S,w as j,x as k,b as y,i as z,y as T,r as m,z as B,A as I}from"./index-b120845e.js";import{u as M,M as A}from"./Modal-1bc4179f.js";import{B as f}from"./Box.styled-8485dffa.js";import{c as _}from"./index.esm-da841f61.js";import{B as u}from"./Button-c6b7a546.js";import{G as v}from"./GridLoader-d4b0f07c.js";import{a as G,H as O}from"./index.esm-2fc47018.js";import{S as W}from"./Section-0afaffcc.js";import"./iconBase-7ca16e1f.js";import"./IconButton-892cd5a6.js";const D=i.li`
  display: flex;
  align-items: center;
...
`,K=({ActiveSeller:e,OffersItems:t,isLoading:n})=>{const r=d(y);return s.jsxs(J,{mediaType:r,children:[n&&s.jsx(f,{style:{width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center"},children:s.jsx(v,{color:o.colors.accent})}),!n&&t.map(a=>s.jsx(P,{mediaType:r,item:a,ActiveSeller:e},a.name))]})},g=i.p`
  font-size: ${o.fontSizes.xl};
  font-weight: ${o.fontWeights.regular};
  text-align: center;
  color: ${o.colors.primary};
`,V=({ActiveSeller:e,toggleModal:t})=>{const n=z(),r=x(),a=()=>{t(),r(T()),r(j()),n("/")};return s.jsxs(f,{display:"flex",flexDirection:"column",alignItems:"center",children:[s.jsxs(g,{children:["The shopping cart contains the goods of the seller &quot",e.toUpperCase(),"&quot!"]}),s.jsx(g,{children:"Do you want to place an order?"}),s.jsx(g,{children:"Or the items will be removed from the cart!"}),s.jsxs(f,{style:{marginTop:o.space[5],display:"flex",gap:o.space[4]},children:[s.jsx(u,{icon:G,onClick:a,children:"Reset Cart"}),s.jsx(u,{icon:O,onClick:()=>n("/cart"),children:"Go to Cart"})]})]})},X=()=>{const[e,t]=m.useState(null),{showModal:n,toggleModal:r}=M();d(y);const a=d(B),{data:c=[],isLoading:p,error:b,refetch:h}=I(e==null?void 0:e._id);return m.useEffect(()=>{t(a)},[a]),m.useEffect(()=>{h()},[h,e]),s.jsx(W,{children:s.jsxs(s.Fragment,{children:[s.jsx(N,{ActiveSeller:e,toggleModal:r}),s.jsx(K,{OffersItems:c,isLoading:p,ActiveSeller:!!e}),n&&s.jsx(A,{toggleModal:r,showModal:n,children:s.jsx(V,{ActiveSeller:e==null?void 0:e.name,toggleModal:r})})]})})},le=X;export{le as default};
